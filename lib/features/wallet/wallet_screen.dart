...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        AppHeader(title: S.t('wallet'), subtitle: S.t('tokens')),
        Expanded(
              ...
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF4CC84A), Color(0xFF2EA3F2)],
                ...
                if (items.isEmpty)
                  Container(
                    ...
                    child: Column(
                      children: [
                        const Icon(Icons.toll, size: 42, color: AppColors.gold),
                  ...
                  ...items.map((item) {
                    ...
                    final positive =
                        amount.contains('+') || !(amount.startsWith('-'));
                    return Container(
                      width: double.infinity,
